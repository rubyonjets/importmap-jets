module Importmap::ImportmapTagsHelper
  ...
  # By default, `Importmap.framework.application.importmap.to_json(resolver: self)` is used.
  def javascript_inline_importmap_tag(importmap_json = Importmap.framework.application.importmap.to_json(resolver: self))
  ...
  # (defaults to Importmap.framework.application.importmap), such that they'll be fetched
  # in advance by browsers supporting this link type (https://caniuse.com/?search=modulepreload).
  def javascript_importmap_module_preload_tags(importmap = Importmap.framework.application.importmap)
